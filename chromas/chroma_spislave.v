...
(
   ...
   localparam [2:0]  STATE_CHECK_CSB_DEASSERT1  = 3'h2;
   localparam [2:0]  STATE_CHECK_COUNT          = 3'h3;
   localparam [2:0]  STATE_GEN_INTERRUPT        = 3'h4;
   localparam [2:0]  STATE_AWAIT_SCLK_FALLING   = 3'h5;
   localparam [2:0]  STATE_CHECK_CSB_DEASSERT2  = 3'h6;

   // Control Register State
   localparam [1:0]  SHIFT_IN_SEL       = 2'h2;  // Shift input data on ui_in[2]
   localparam [1:0]  SHIFT_OUT_SEL      = 2'h0;  // Not using shift out
   localparam [2:0]  COND_OUT_SEL       = 3'h1;  // Route cond_out to uo_out[2]
