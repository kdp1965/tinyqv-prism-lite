...
`endif
    ...
    assign latch_in   = (shift_mode == 2'b10 && prism_out_data[OUT_SHIFT]) | (latch5 && prism_out_data[OUT_COUNT2_DEC]);
    ...
    */
    ...
    assign ctrl_bits_in[15]    = latch_data[13];    // latch5
    ...
    assign latch5              = ctrl_bits_out[15];
